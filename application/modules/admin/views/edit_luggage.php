		...
		?>
		 	...
		 	<h4>
				<div class="form-group">
				   ...
				   <div class="col-sm-8">				   		
						<input type="text" class="form-control1" name="airline_name" value="<?php echo $row[0]['airline_name'];?>">
					</div>									
				</div>	
				<div class="form-group">
				   <label for="focusedinput" class="col-sm-2 control-label">Airline Code</label>
				   <div class="col-sm-8">
						<input type="text" class="form-control1" name="airline_code" value="<?php echo $row[0]['airline_code'];?>">
					</div>									
				</div>					
				<div class="form-group">
				   <label for="focusedinput" class="col-sm-2 control-label">Bag Weight</label>
				   <div class="col-sm-8">
						<input type="text" class="form-control1" name="weight" value="<?php echo $row[0]['weight'];?>">
					</div>									
				</div>	
				<div class="form-group">
				   <label for="focusedinput" class="col-sm-2 control-label">Price per one bag</label>
				   <div class="col-sm-8">
						<input type="text" class="form-control1" name="price" value="<?php echo $row[0]['price'];?>">
					</div>									
				</div>		
				 <div class="reg-bwn"><button class="btn btn-primary" type="submit" >UPDATE</button></div>      					
			<?php echo form_close();?>	
