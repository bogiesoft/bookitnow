...
<div class="col-sm-3">	
	...
	<div class="conatiner-bg">	
		...
		<h5><b>Flight <?php echo $hobjs[0]['@attributes']['nights'];?> Nights</b>	</h5>		
		<h5><?php echo urldecode($hobjs[0]['@attributes']['Flightname']);?></h5>
		...
		<div class="left">
         ...
         <div class="flight-wrap"><a href="<?php echo base_url().'FlightsAvailability/'.$this->uri->segment(2);?>" onClick="return Change('full_hotel','<?php echo $this->uri->segment(2);?>')">change</a></div>	
		<br>	
	</div>
	<div class="conatiner-bg">	  
		 <div class="conatiner-bg">
