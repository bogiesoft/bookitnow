			    ...
			    <div class="row mar-b-50 our-clients">
			       <div class="col-md-3">
				       <div class="great">
							...
							<p>	Based on 639 reviews See some of the reviews here.</p>
							<p> <i class="fa fa-check-square"></i>Trustpilot </p>		
						</div>
			        </div>
			        <div class="col-md-9">
			          <div class="outside">
						...
						<div class="col-sm-4">
							<div  class="super">
								...
								<ul>
									...
									<li><a href="https://plus.google.com/+BookitnowUkBookitNowHolidays/posts" target="_blank"><i class="fa fa-google-plus"></a></i></li>
								</ul>
							</div>
						</div>			
						<div class="col-sm-4">
